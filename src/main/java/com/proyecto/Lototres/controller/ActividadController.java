...
public class ActividadController {
    ...
    public ResponseEntity <Actividad> getById_act(@PathVariable("id_act") Long id_act){
    ...
    public ResponseEntity<?> update (@PathVariable("id_act") Long id_act, @RequestBody ActividadDto actividadDto){
        if(!actividadService.existsById(id_act))
            return new ResponseEntity(new Mensaje("No existe la actividad"), HttpStatus.NOT_FOUND);
    ...
    public ResponseEntity<?> delete (@PathVariable("id_act") Long id_act){
        if(!actividadService.existsById(id_act))
            return new ResponseEntity(new Mensaje("No existe la actividad"), HttpStatus.NOT_FOUND);
